...
# Tugas
# aku akan memvisualisasikan pengeluaran ('Spending Score (1-100)') pelanggan berdasarkan 'Genre' dan 'Range Usia'. Aku akan menggunakan grouped bar chart dan pie chart.