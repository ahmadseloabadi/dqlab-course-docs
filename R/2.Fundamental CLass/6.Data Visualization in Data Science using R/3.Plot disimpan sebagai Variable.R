...
# Pada code editor telah terdapat code lengkap untuk menghasilkan suatu plot. Ubahlah code tersebut sehingga plot ini disimpan ke variable bernama plot.jakarta sesuai contoh di atas, termasuk untuk menampilkan grafik.