...
# Anda akan diminta untuk menempuh cara nomor 2, yaitu dengan cara melakukan pivot pada data terlebih dahulu. Ketik TRUE pada Code Editor jika Anda setuju!